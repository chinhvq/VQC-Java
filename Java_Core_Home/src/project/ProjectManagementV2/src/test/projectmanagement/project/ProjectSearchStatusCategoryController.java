...
public class ProjectSearchStatusCategoryController {
	...
	public void listShow() {
		...
		task.setOnSucceeded(e -> {
			...
			countLabel.setText("Number of return records = " + String.valueOf(DataSourceProject.getInstance()
...
class SearchProjectStatusCategory extends Task<ObservableList<Project>> {
	...
	public ObservableList<Project> call() throws Exception {
		return FXCollections.observableArrayList(
				(DataSourceProject.getInstance().searchProjectStatusCategory(Main.projectStatus, Main.projectCategory)));
	}
}
