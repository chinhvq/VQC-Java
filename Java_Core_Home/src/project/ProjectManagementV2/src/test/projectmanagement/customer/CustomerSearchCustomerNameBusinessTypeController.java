...
public class CustomerSearchCustomerNameBusinessTypeController {
	@FXML
	BorderPane mainPane;
	@FXML
	...
	public void listShow() {
		...
		countLabel.setText("");
		Task<ObservableList<Customer>> task = new SearchCustomerNameBusinessType();
		...
		task.setOnSucceeded(e -> {
			...
			countLabel.setText("Number of return records = " + String.valueOf(DataSourceCustomer.getInstance()
					.searchCustomerNameBusinessTypeCount(Main.customerName, Main.businessType)));
		});
		task.setOnFailed(e -> {
			progressBar.setVisible(false);
...
class SearchCustomerNameBusinessType extends Task<ObservableList<Customer>> {
	@Override
	public ObservableList<Customer> call() throws Exception {
		return FXCollections.observableArrayList(
				(DataSourceCustomer.getInstance().searchCustomerNameBusinessType(Main.customerName, Main.businessType)));
	}
}
